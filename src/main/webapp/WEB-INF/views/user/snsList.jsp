			...
			<div class="row">
				<aside class="col-sm-2">
					<div class="aside-inner">
						<div class="menu1">
							<p>
								<img src="../resources/img/profile.png">${sessionScope.userVO.userName}
							</p>
							<ul>
								<li>내정보</li>
								<li>내쿠폰</li>
	...
	$(document).ready(function(){
		...
		function regist(){
			...
			if(file !="jpg" &&file != "png" && file!= "jpeg" && file!="gif"){
				alert("이미지(jpg,gif,png,jpeg)만 등록 가능");
				return;
			}else if(false /*writer == ''*/){//세션이 없다면
			...
			$.ajax({
				type:"POST",
				url:"upload",
				processData: false,//폼 형식이 &변수=값 의 형태로 변경되는 것을 막는다
